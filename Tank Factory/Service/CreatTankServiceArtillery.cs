...
{
    public class CreatTankServiceArtillery
    {
        public ArtilleryMount GetTankArtillery(string type, Chassis chassis, Engine engine, Frame frame, Weapon weapon, DateTime dateTime, Factory factory)
        {
